...
const App = () => {
  ...
  // Another function on button click
        ...
        <>
          ...
          <Stack maxW="900px" mx="auto">
            ...
            <List>
              ...
              <ListItem>
                Select number is equal to obtain results then you will get the
                same points of the dice
              </ListItem>
              <ListItem>
                Select number is equal to obtain results then you will get the
                same points of the dicef
              </ListItem>
            </List>
          </Stack>
        </>
