...
*  github: https://github.com/cevadtokatli/window-date-picker-react
* license: MIT
*/
...
function () {
  ...
  function WindowDatePicker(opt) {
    ...
    _classCallCheck$1(this, WindowDatePicker);
    ...
    this.initialValue = _objectSpread$1({}, this.value);
    this.els = {};
  ...
  _createClass$1(WindowDatePicker, [{
    ...
    value: function changeDatePage(val) {
      ...
      if (val == MONTH) {
        ...
        if (v == YEAR) {
          this.tmpYearRangeValue = _objectSpread$1({
      ...
      if (typeof v === 'string') {
        ...
        if (this.type != DATE) {
          ...
          var _s$0$split = s[0].split(':'),
              _s$0$split2 = _slicedToArray$1(_s$0$split, 2),
              hour = _s$0$split2[0],
    ...
    value: function setDay(day, month, year) {
      ...
      this.value = _objectSpread$1({}, this.value, {
        day: day,
        weekDay: weekDay,
        month: month,
        year: year
    ...
    value: function cancel() {
      this.value = _objectSpread$1({}, this.initialValue);
...
var WindowDatePicker$1 =
/*#__PURE__*/
function (_React$Component) {
  _inherits(WindowDatePicker$$1, _React$Component);

  function WindowDatePicker$$1() {
    _classCallCheck(this, WindowDatePicker$$1);

    return _possibleConstructorReturn(this, _getPrototypeOf(WindowDatePicker$$1).apply(this, arguments));
  }

  _createClass(WindowDatePicker$$1, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.wdp = new WindowDatePicker({
        el: this.el,
    ...
    key: "createLanguage",
    value: function createLanguage(name, lang) {
      WindowDatePicker.createLanguage(name, lang);
    }
  }]);

  return WindowDatePicker$$1;
}(react.Component);
WindowDatePicker$1.propTypes = {
  value: propTypes.oneOfType([propTypes.string, propTypes.number, propTypes.instanceOf(Date)]),
  inputEl: propTypes.oneOfType([propTypes.string, propTypes.instanceOf(HTMLInputElement)]),
  toggleEl: propTypes.oneOfType([propTypes.string, propTypes.instanceOf(HTMLElement)]),
...
export default WindowDatePicker$1;
